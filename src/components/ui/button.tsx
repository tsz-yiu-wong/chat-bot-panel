...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-blue-50 hover:bg-blue-100 text-blue-700 dark:bg-blue-900/20 dark:hover:bg-blue-900/30 dark:text-blue-300 focus:ring-blue-500',
      secondary: 'bg-gray-100 hover:bg-gray-200 text-gray-700 dark:bg-[var(--accent-background)] dark:hover:bg-[var(--border-color)] dark:text-gray-300 focus:ring-gray-500',
