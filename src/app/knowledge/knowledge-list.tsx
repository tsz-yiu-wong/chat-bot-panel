...
import { AddKnowledgeDialog } from './dialog-add-knowledge';
import { EditKnowledgeDialog } from './dialog-edit-knowledge';
...
export function KnowledgeList({ initialCategories, initialItems }: KnowledgeListProps) {
  ...
  const getDeleteText = () => {
    ...
    return t('common.actions.delete_confirm', { type, name: value });
  };
      ...
      <div className="mb-2 ml-2">
        <p className="text-sm text-muted-foreground">
          {t('common.messages.total_count', { 
            ...
            module: t('knowledge.module_name') 
          })}
        </p>
      </div>
          ...
          {filteredItems.length === 0 && (
            <div className="text-center py-12">
              <p className="text-muted-foreground">
                {t('common.messages.no_results', { module: t('knowledge.module_name') })}
              </p>
            </div>
          )}
        </div>
